...
public abstract class Skybox extends Group{

    //number of images that are used to build the skybox: SINGLE (sideways cross of environemnt),
    //  MULTIPLE with 6 individual images
    ...
    protected void setMultipleImages() {
