...
/*/
    ...
    Box boxers2 = createsolar(solarPanelTwo, 39, 3.64, 65, rAX, rAZ, rAY);
       ...
       sun.setTranslateZ(0);
            ...
            sun1.setTranslateX(x66*500);
            sun1.setTranslateY(y66*500);
        ...
        sun3.setTranslateX(x12*500);
        sun3.setTranslateY(y12*500);
        sun3.setTranslateZ(0);
           sceneRoot.getChildren().add(sun3);
        double angle3 = 90;
        angle3 = Math.toRadians(angle3);
        double x90 = Math.cos(angle3);
        double y90 = Math.sin(angle3);
           sun4.setTranslateX(x90*500);
           sun.setTranslateZ(0);
           sun4.setTranslateY(y90*500);
